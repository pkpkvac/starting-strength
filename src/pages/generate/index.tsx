  ...
  return (
    <>
      <WithViewHeader backHref="/" title="Generate Routine">
        ...
        <div className="mb-10 flex h-min w-3/4 flex-col justify-between justify-self-center rounded-xl bg-primary-light px-14 pt-14 pb-2">
          {/* title */}
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <input
                      type="number"
                      id="squat"
                      className="block rounded-md border border-gray-300 p-2 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                      placeholder=""
                      {...register("squat", {
